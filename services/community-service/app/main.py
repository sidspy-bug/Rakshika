...
from .core.event_listener import CommunityEventListener
...
async def lifespan(app: FastAPI):
    ...
    # Initialize Redis for SOS event listening
    redis_client = None
    event_listener = None
    try:
        ...
        logger.info("Redis connected for community event listening")
        
        event_listener = CommunityEventListener(
        ...
        logger.warning("Redis unavailable — community event listener disabled: %s", exc)
