...
class EmergencyController:
    ...
    async def relay_upload(self, principal: Principal, payload: MeshRelayUploadRequest) -> EmergencyRead:
        emergency = await self._service.relay_upload(principal.user_id, payload)
        return EmergencyRead.model_validate(emergency)
