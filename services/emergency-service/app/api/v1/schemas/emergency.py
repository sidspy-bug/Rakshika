...
class MeshRelayUploadRequest(BaseSchema):
    """Payload to upload a relayed SOS emergency."""
    ...
    relayed_by: str = Field(default="self", alias="relayedBy", max_length=255)
    hmac_signature: str = Field(..., alias="hmacSignature", max_length=255)
