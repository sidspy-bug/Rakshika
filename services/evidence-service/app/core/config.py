...
class EvidenceServiceSettings(AppSettings):
    """Top-level evidence service settings."""

    app_name: str = "Rakshika Evidence Service"
...
@lru_cache(maxsize=1)
def get_settings() -> EvidenceServiceSettings:
    """Return a cached evidence service settings instance."""
