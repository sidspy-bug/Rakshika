"""Rakshika location service application."""
...
from .api.v1.routers.location import router as location_router
...
async def lifespan(app: FastAPI):
    ...
    logger = logging.getLogger("rakshika.location")
    ...
    logger.info("Location service resources initialized")
    try:
        yield
    finally:
        await db.dispose()
        logger.info("Location service resources released")
