"""Rakshika user service application."""
...
async def lifespan(app: FastAPI):
    ...
    logger = logging.getLogger("rakshika.user")
    ...
    logger.info("User service resources initialized")
    try:
        yield
    finally:
        await db.dispose()
        logger.info("User service resources released")
